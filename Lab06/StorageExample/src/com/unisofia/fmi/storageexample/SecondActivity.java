...
public class SecondActivity extends Activity implements OnClickListener {
    ...
    private void readFromSharedPreferences() {
        SharedPreferences sharedPreferences = getSharedPreferences(SharedPrefsConsts.NAME,
    ...
    private void readFromExternalStorage() {
        ...
        File dir = new File(
                sdCard.getAbsolutePath() + File.separator + FileConsts.FOLDER_NAME + File.separator + FileConsts.FILE_NAME);
